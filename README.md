...
|  경동원  | O  |  O  | X  |  O  |  X  |  O   |   O   |  X   |  X   |   O   |  O   |  X  |
|  이지빌  | O  |  O  | X  |  O  |  X  |  O   |   O   |  X   |  X   |   O   |  O   |  X  |
| CVnet | O  |  O  | △  |  O  |  △  |  O   |   O   |  X   |  X   |   O   |  O   |  X  |
| 삼성SDS | O  |  O  | △  |  O  |  X  |  O   |   O   |  X   |  X   |   O   |  O   |  △  |
...
* △로 표시된 항목은 기능은 구현되어있지만 테스트를 하지 못한 항목입니다.<br>한번 사용해보고 이상작동 시 담다패드를 비활성화/삭제 하고 알려주세요.
* X 항목이 월패드에서 조회/제어가 된다면 게시판에 문의 남겨주세요.(일괄스위치 제외)
