...
- 본 소프트웨어는 제조사의 정식 서비스를 이용하지 못하는 사용자에 한해 개인적인 용도로만 사용하기를 권장합니다.
- 본 소프트웨어의 사용책임은 전적으로 사용자에게 있습니다.
- 본 소프트웨어의 상업적 이용을 하용하지 않습니다.
- 본 소프트웨어의 무단배포를 허용하지 않습니다.
...
- 본 소프트웨어는 `스마트홈 기기제어 프로토콜`인 `KSX4506`을 지원합니다.
...
| ----------- | :------: | :--: | ---------------------------- |
| 삼성전자    |    O     |  O   | 시스템에어컨(구통신)         |
| LG전자      |    O     |  O   | 시스템에어컨(모드버스/PI485) |
| 그렉스      |    O     |  O   | 전열교환기                   |
| 에어패스    |    O     |  O   | 전열교환기                   |
| 정민/에이피 |    O     |  O   | 전열교환기                   |
| 진성        |    O     |  O   | 전열교환기                   |

| 제조사   | 조명 | 디밍 | 콘센트 | 커튼 | 환기 | 보일러 | 에어컨 | 가스차단 | E/V호출 | 일괄소등 | 현관모션 | 일괄스위치 | 원격검침 | 인터폰 |
| -------- | :--: | :--: | :----: | :--: | :--: | :----: | :----: | :------: | :-----: | :------: | :------: | :--------: | :------: | ------ |
| 코콤     |  O   |  O   |   O    |  X   |  O   |   O    |   O    |    O     |    O    |    O     |    O     |     X      |    X     | X      |
| 코맥스   |  O   |  X   |   O    |  X   |  O   |   O    |   X    |    O     |    O    |    O     |    X     |     X      |    X     | X      |
| 현대통신 |  O   |  O   |   O    |  X   |  O   |   O    |   O    |    O     |    O    |    X     |    X     |     O      |    O     | X      |
| 경동원   |  O   |  X   |   O    |  X   |  O   |   O    |   X    |    O     |    O    |    X     |    X     |     O      |    O     | X      |
| 홈넷홈   |  O   |  X   |   O    |  X   |  O   |   O    |   X    |    O     |    O    |    X     |    X     |     O      |    O     | X      |
| 이지빌   |  O   |  X   |   O    |  X   |  O   |   O    |   X    |    O     |    O    |    O     |    X     |     O      |    O     | X      |
| CVnet    |  O   |  O   |   O    |  X   |  O   |   O    |   △    |    O     |    O    |    X     |    X     |     O      |    O     | X      |
| 삼성SDS  |  O   |  X   |   O    |  X   |  O   |   O    |   X    |    O     |    O    |    X     |    X     |     O      |    O     | X      |
| TEC&CO   |  O   |  O   |   X    |  O   |  O   |   O    |   X    |    O     |    X    |    X     |    X     |     X      |    X     | X      |
| 허니웰   |  X   |  X   |   X    |  X   |  X   |   O    |   X    |    X     |    X    |    X     |    X     |     X      |    X     | X      |
...
- **허니웰** > 자동인식`(자동인식이 안되면 월패드에서 조회/제어해보세요)`
