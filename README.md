...
| 코콤     | v1.0 | 2021.xx.xx |
| 코맥스   | v1.0 | 2021.xx.xx |
| 현대통신 | v1.0 | 2021.xx.xx |
| 경동원   | v1.0 | 2021.xx.xx |
| 이지빌   | v1.0 | 2021.xx.xx |
| CVnet    | v1.0 | 2021.xx.xx |
| 삼성SDS  | v1.0 | 2021.xx.xx |
| 홈넷홈   | v1.0 | 2021.xx.xx |
| TEC&CO   | v1.0 | 2021.xx.xx |
| 삼성전자 | v1.0 | 2021.xx.xx |
| LG전자   | v1.0 | 2021.xx.xx |
| 그렉스   | v1.0 | 2021.xx.xx |
| 에어패스 | v1.0 | 2021.xx.xx |
| 정민     | v1.0 | 2021.xx.xx |
...
- 옵션 `가스 밸브`의 기본값은 비활성화 입니다. 활성화 시 전송간격\*10 주기로 제어명령을 보냅니다.<br/>밸브가 전자식이 아닌 기계식일 경우 활성화하면 됩니다.
...
- **경동원** > 월패드에서 조회 혹은 조작하기`(자동인식이 안되면 월패드에서 제어해보세요)`
  ...
  - 난방 > 상태조회 혹은 조작
  - 가스차단 > 자동인식
  - 경동원 전열교환기 -> 자동인식`(모드인식은 월패드에서 제어 후 담다패드를 다시 읽어오기 하세요)`
  - 경동나비엔 에어원 환기장치 -> 자동인식
  - 엘레베이터 > 자동등록`(미작동시 사용금지)`
